...
/**
 * Util class for generating image and avatar URLs.
 *
 * @author beta
 */
public class ImageUtil {
    ...
    private ImageUtil(Context context) {
        ...
        imageQualityOverCellular = pref.readInt(PreferenceUtil.PREF_IMAGE_QUALITY_OVER_CELLULAR);
        imageQualityOverWifi = pref.readInt(PreferenceUtil.PREF_IMAGE_QUALITY_OVER_WIFI);
        prefix = pref.readString(PreferenceUtil.PREF_IMAGE_SOURCE);
    }
