...
/**
 * A custom {@link Request} to send a comment to a tweet.
 *
 * @author beta
 */
public class CommentRequest extends Request<TweetId> {

    private final static String API_URL = "https://open.t.qq.com/api/t/comment";
     ...
     * @param tweetId         ID of tweet on which to comment
     ...
     */
    public CommentRequest(RequestActivity activity, Long tweetId, String content,
        ...
        request = new PostRequest(API_URL,
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            CommentRequestResult result = new CommentRequestResult(response);
    ...
    private class CommentRequestResult extends RequestResult<TweetId> {

        public CommentRequestResult(JSONObject response) throws RequestError {
            super(response);
        }
